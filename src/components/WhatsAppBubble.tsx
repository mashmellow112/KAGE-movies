  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="relative w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_10px_40px_-10px_rgba(37,211,102,0.5)] cursor-pointer group border-2 border-white/20 overflow-hidden"
      >
        <div className="absolute -top-16 right-0 bg-white text-gray-800 px-5 py-3 rounded-2xl text-xs font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0 pointer-events-none whitespace-nowrap shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)] border border-gray-100 flex items-center gap-2">
